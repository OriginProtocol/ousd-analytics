...
from core.blockchain.strategies import STRATEGIES, VAULT, STRATCOMP, STRATAAVE, MORPHO, OUSD_METASTRAT, LUSD_METASTRAT, MORPHO_AAVE, STRATCONVEX
...
CURVE_METAPOOL = "0x87650d7bbfc3a9f10587d7778206671719d9910d" # aka OUSD<>3CRV MetaPool
